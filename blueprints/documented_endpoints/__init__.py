...
from blueprints.documented_endpoints.jinja_templates import namespace as jinja_templates_ns

blueprint = Blueprint('documented_api', __name__, url_prefix='/documented_api')

api_extension = Api(blueprint,
    title='Flask RESTful demo',
    version='1.0',
...
api_extension.add_namespace(jinja_templates_ns)